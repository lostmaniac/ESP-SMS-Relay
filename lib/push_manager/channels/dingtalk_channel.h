...
#ifndef DINGTALK_CHANNEL_H
#define DINGTALK_CHANNEL_H
 ...
 * 实现钉钉机器人推送功能
 */
class DingtalkChannel : public PushChannelBase {
public:
    /**
     * @brief 构造函数
     */
...
private:
     ...
     * @return String 签名
     */
    String generateSign(const String& timestamp, const String& secret);
};

#endif // DINGTALK_CHANNEL_H